...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (console, id, location, path, title) {
	buf.push("<!DOCTYPE html><html><head><title>" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)) + "</title><link href=\"https://cdn.auth0.com/styleguide/4.8.13/index.min.css\" rel=\"stylesheet\"></head><body><div class=\"logo-branding\"><img src=\"https://styleguide.auth0.com/lib/logos/img/logo-blue.png\" width=\"100px\"></div><div class=\"main container\"><div class=\"row\"><div class=\"col-md-6 col-md-offset-3\"><h1 class=\"display-4 m-b-2\">Call to Verify</h1><p>Please enter your phone number</p><!-- phone form-->");
	var page = location.pathname;
	console.log(page);
	buf.push("<form method=\"POST\"" + (jade.attr("action", '/' + (page) + '', true, true)) + (jade.attr("name", '/' + (path) + '', true, true)) + "><div class=\"form-group\"><label for=\"phone\">Phone Number:</label><input id=\"phone\" name=\"phone\" type=\"tel\" placeholder=\"+1777-777-7777\" required class=\"form-control\"><input id=\"type\" name=\"type\" type=\"hidden\" value=\"call\" class=\"form-control\"><input id=\"id\" name=\"id\" type=\"hidden\"" + (jade.attr("value", '' + (id) + '', true, true)) + " class=\"form-control\"></div><button type=\"submit\" class=\"btn btn-primary\">Call me</button></form></div></div></div></body></html>");}.call(this,"console" in locals_for_with?locals_for_with.console:typeof console!=="undefined"?console:undefined,"id" in locals_for_with?locals_for_with.id:typeof id!=="undefined"?id:undefined,"location" in locals_for_with?locals_for_with.location:typeof location!=="undefined"?location:undefined,"path" in locals_for_with?locals_for_with.path:typeof path!=="undefined"?path:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined));;return buf.join("");
	}
