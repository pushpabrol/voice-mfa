...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (id, path, title, window) {
	...
	var pathing = window.location.pathname;
	buf.push("<form method=\"POST\"" + (jade.attr("action", '/' + (pathing) + '', true, true)) + (jade.attr("name", '/' + (path) + '', true, true)) + "><div class=\"form-group\"><label for=\"phone\">Phone Number:</label><input id=\"phone\" name=\"phone\" type=\"tel\" placeholder=\"+1777-777-7777\" required class=\"form-control\"><input id=\"type\" name=\"type\" type=\"hidden\" value=\"call\" class=\"form-control\"><input id=\"id\" name=\"id\" type=\"hidden\"" + (jade.attr("value", '' + (id) + '', true, true)) + " class=\"form-control\"></div><button type=\"submit\" class=\"btn btn-primary\">Call me</button></form></div></div></div></body></html>");}.call(this,"id" in locals_for_with?locals_for_with.id:typeof id!=="undefined"?id:undefined,"path" in locals_for_with?locals_for_with.path:typeof path!=="undefined"?path:undefined,"title" in locals_for_with?locals_for_with.title:typeof title!=="undefined"?title:undefined,"window" in locals_for_with?locals_for_with.window:typeof window!=="undefined"?window:undefined));;return buf.join("");
	}
