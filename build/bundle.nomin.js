...
/***/ function(module, exports) {
	...
	function getRulesBody(vars) {
	  ...
	  return rule.replace('fb-name', vars.FB_PROJECT_ID).replace('fb-client-email', vars.FB_CLIENT_EMAIL).replace('fb-private-key', vars.FB_PRIVATE_KEY).replace('fb-db-url', vars.FB_DB_URL);
